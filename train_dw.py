...
def train_syndiff(rank, gpu, args):
    ...
    from backbones.ncsnpp_generator_adagn_feat_dw1 import NCSNpp_Freq
    from backbones.ncsnpp_generator_adagn_feat_dw1 import NCSNpp_Spatial
    ...
    for epoch in range(init_epoch, args.num_epoch + 1):
        ...
        for iteration, (x1, x2, x3, x4) in enumerate(data_loader):
            ...
            x2_0_predict_diff_g1 = gen_diffusive_1(x2_tp1.detach(), cond_data1.detach(), cond_data2.detach(), cond_data3.detach(), t2, latent_z2)
